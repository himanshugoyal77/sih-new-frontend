...
import userAnimation from "../assets/lottie/animation_lncw8k8l.json";
...
const Register = ({ isUpdateProfile }) => {
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center bg px-20">
      <div className="w-[20%] flex flex-col items-center text-center gap-5">
        <Lottie
      ...
      <div className="flex-grow ">
        ...
        <div className="mx-auto  py-4 px-8 border-l-2 border-black">
          <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg">
            <div className="wifull flex justify-between items-start">
              {/* <h1 className="text-2xl">
              {isUpdateProfile ? "Update Profile" : "Register"}
            </h1> */}
          ...
          px-4 py-2 border-1 shadow-lg text-white bg-black hover:bg-gradient-to-br  focus:outline-none  font-medium rounded-lg text-sm text-center mr-2 mb-2"
              >
                Register
              </button>
            </div>
